function setup() {
  ...
  var mediaesferaForma = new THREE.SphereGeometry( 1, 100, 50, 0, Math.PI*2, 3*Math.PI/2, Math.PI);
  var mediaesferaForma2 = new THREE.SphereGeometry( 0.8, 100, 50, 0, Math.PI*2, 7*Math.PI/4, Math.PI/4);
